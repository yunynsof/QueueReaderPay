...
import hn.com.tigo.queue.listener.ReaderQueuePayMasterThread;
...
public class ListenerTest {
	...
	public void test() {
		...
		ReaderQueuePayMasterThread thread = new ReaderQueuePayMasterThread();
